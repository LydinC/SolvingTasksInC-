...
int main(void) {
	...
	printf("\n");
	printf("The time taken for the Naive Sort to execute is %0.2fms.", (timeTaken*1000));
	printf("\n\n");
	...
	printf("\n");
	printf("The time taken for the Smarter Sort to execute is %0.2fms.", (timeTaken*1000));
	printf("\n\n");
